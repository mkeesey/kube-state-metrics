...
`,
	...
	for i, c := range cases {
		c.Func = generator.ComposeMetricGenFuncs(namespaceMetricFamilies(nil, nil, KeepAllFilter))
		c.Headers = generator.ExtractMetricFamilyHeaders(namespaceMetricFamilies(nil, nil, KeepAllFilter))
